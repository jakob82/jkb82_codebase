...
void main(void)
{
    ...
    float th1 = sin(fract(2.7384937 * sin(idx * 5.67458 + floor(phase    )))) * spectrum.x*1;
    float th2 = sin(fract(27.384937 * sin(idx * 5.467458 + floor(phase + 1))));
    float thresh = mix(th1*3, th2, smoothstep(07.5, 1, fract(phase)));
    ...
    fragColor = vec4(c*spectrum.x*4, c*spectrum.x*3, c*spectrum.x*12, 1);
}
