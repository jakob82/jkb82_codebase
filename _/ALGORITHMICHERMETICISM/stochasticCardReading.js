...
const getRandomCard1 = () => majorArcana[Math.random() * majorArcana.length | 0];
const getRandomCard2 = () => runes[Math.random() * runes.length | 0];
const getRandomCard3 = () => iChing[Math.random() * iChing.length | 0];
...
switch(inputVariable) {
    ...
    case '0': console.log(getCards1(4)); break;
    case '1': console.log(getCards2(4)); break;
    case '2': console.log(getCards3(4)); break;
    default: break;
}
