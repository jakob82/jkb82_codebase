const mat2 m = mat2 (0.125, 0.25, -1, 0.75);
 ...
 { 
	 vec2 p = (-iResolution.yy+2.0*fragCoord.xx)/iResolution.y; 
	 ...
	 col += 0.05*nor.y*nor.x*nor.y; 
	

	

	 vec2 q = fragCoord.xx/iResolution.xx;
	 col *= pow(32.0*q.y*q.y*(1.0-q.y)*(1.0-q.x),0.1); 
